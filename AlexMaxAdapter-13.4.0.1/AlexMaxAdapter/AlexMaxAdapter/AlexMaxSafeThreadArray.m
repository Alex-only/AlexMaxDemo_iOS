...
@implementation AlexMaxSafeThreadArray {
...
- (BOOL)isEqualToArray:(NSArray *)otherArray {
    ...
    if ([otherArray isKindOfClass:AlexMaxSafeThreadArray.class]) {
        AlexMaxSafeThreadArray *other = (id)otherArray;
        BOOL isEqual;
...
- (BOOL)isEqual:(id)object {
    ...
    if ([object isKindOfClass:AlexMaxSafeThreadArray.class]) {
        AlexMaxSafeThreadArray *other = object;
        BOOL isEqual;
        pthread_mutex_lock(&_mutex_lock);
        pthread_mutex_lock(&(other->_mutex_lock));
